...
public class JavaBeanTrader 
{
	...
	public JavaBeanTrader(String name, String mobile, String aadharnum, String email, String state, String district,
			String taluk, String hobli, String village, String bankname, String accountnum, String branch, String ifsc,
			String tuid, String license, String password, InputStream photo) {
		super();
		this.name = name;
		this.mobile = mobile;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		JavaBeanTrader other = (JavaBeanTrader) obj;
		if (aadharnum == null) {
	...
	public String toString() {
		return "JavaBeanTrader [name=" + name + ", mobile=" + mobile + ", aadharnum=" + aadharnum + ", email=" + email
				...
				+ ifsc + ", tuid=" + tuid + ", license=" + license + ", password=" + password + ", photo=" + photo
				+ "]";
	}
