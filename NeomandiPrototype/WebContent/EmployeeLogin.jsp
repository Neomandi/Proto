...
<div class="col-lg-offset-6 col-lg-3 col-md-offset-5 col-md-3 col-sm-offset-4 col-sm-4 col-xs-offset-1 col-xs-6">
<form action="EmployeeLoginInt.jsp" method = "post"  name = "EmployeeLoginform">
<table class="table login">
<tbody>
<tr><td><h2>Employee Login</h2></td></tr>
<tr><td><input type="text" class="form-control" id="usr" placeholder="User name" name="ename"></td></td></tr>
<tr><td><input type="password" class="form-control" id="usr" placeholder="Password" name="epwd"></td></td></tr>
