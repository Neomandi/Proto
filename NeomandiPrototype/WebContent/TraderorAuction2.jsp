...
%>	<div class="one">
	...
	<tr><td><h4>Available Lot Size (kg) (kg)</h4></td><td><input class="form-control" id="usr" type="text" value="<%= tlb.getQuantity()%>"readonly ></td></tr>
	</tbody>
	</table>
	...
	<tr><td><h4>Best Bid</h4></td><td><h4>My Bid(Rs/kg)</h4></td></tr>
