               ...
               <table class="table sum1table last">
                  <thead>
                     <tr>
                        ...
                        <td>
                           <h4>Lot Size<br/>(kg)</h4>
                        </td>
                        <td>
                           <h4>Quantity sold<br/>(kg)</h4>
                        </td>
                        <td>
                           <h4>Avg Price<br/>(Rs)</h4>
                        </td>
                        <td>
                           <h4>Gross Earnings<br/>(Rs)</h4>
                        </td>
                        <td>
                           <h4>TLC<sup>*</sup><br/>(Rs)</h4>
                        </td>
                        <td>
                           <h4>Market Cess<br/>(Rs)</h4>
                        </td>
                        <td>
                           <h4>EPC<sup>#</sup><br/>(Rs)</h4>
                        </td>
                        <td>
                           <h4>PMVA<sup>^</sup><br/>(Rs)</h4>
                        </td>
                        <td>
                           <h4>Deductions<br/>(Rs)</h4>
                        </td>
                        <td>
                           <h4>My Net Earnings<br/>(Rs)</h4>
                        </td>
                        <td></td>
                     </tr>
                  </thead>
                  <tbody>
                     ...
                     <tr class="gradeX">
                        <td></td>
                        <td class="clspad0">
                           <h4 style="color:#000080"><b><%=rs1.getString("lotnumber") %></b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080; font-wieght:bold;"><b><%=rs1.getString("quantity") %></b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080 ;font-wieght:bold;"><b><%=rs1.getString("quantitybidfor")%></b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080; font-wieght:bold;"><b><%=rs1.getString("averageprice") %></b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080; font-wieght:bold;"><b><%=fprice %></b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080; font-wieght:bold;"><b>500</b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080;font-wieght:bold;"><b><%=MUCharge%></b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080; font-wieght:bold;"><b>100</b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080; font-wieght:bold;"><b>100</b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080; font-wieght:bold;"><b><%=deduction%></b></h4>
                        </td>
                        <td  class="clspadr0">
                           <h4 style="color:#000080"><b><%=myEarn %></b></h4>
                        </td>
                        <td></td>
                     </tr>
                     <%
