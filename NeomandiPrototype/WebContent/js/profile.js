...
/*
 |--------------------------------------------------------------------------
 | This file contains profile of how to use this plugin
 |--------------------------------------------------------------------------
 |
 | To see what the pdfs generated by these profile looks like you can open
 | ´profile.html´ or go to http://simonbengtsson.github.io/jsPDF-AutoTable.
 |
 | To make it possible to view each example in profile.html some extra code
 | are added to the profile below. For example they return their jspdf
...
profile.html = function (nm) {
    var doc = new jsPDF('portrait', 'pt','a4');
    doc.text("NeoMandi "+nm+" Profile", 40, 30);
...
profile['header-footer'] = function () {
    var doc = new jsPDF('p', 'pt');
...
/*
 |--------------------------------------------------------------------------
 | Below is some helper functions for the profile
 |--------------------------------------------------------------------------
 */
