...
<p style="font-size:16px; color:white;"><%=name %>,&nbsp;&nbsp;<%=session.getValue("f.welcome") %>.</p></div>
        ...
        <div class="container-fluid today">
            <div class="container">
                <h2><%=session.getValue("f.summary") %></h2></div>
        </div>
        <% 
    	...
    	System.out.println(" in before auction password="+pass);
	    ...
	    System.out.println(" in Before auction lotnumber="+lotnumber);
                            ...
                            <tbody>
                                <tr class="gradeX">
                                    ...
                                    <td class="clspadr0">
                                        <h4 style="color:#000080">--</h4></td>
                                    <td width="15%">
                                        <h4 style="color:#000080"><b><%=status %></b></h4></td>
                                    <td></td>
                                </tr>
