...
<div class="col-lg-1 col-sm-2 col-md-2 col-xs-2 power"><a class="pull-right" href="logout.do" style="position: absolute; right: -99px;"><i class="fa fa-power-off" aria-hidden="true"></i></a></div>
</div>
</div>
