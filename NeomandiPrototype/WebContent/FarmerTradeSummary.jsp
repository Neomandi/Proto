   ...
   <body class="">
      ...
      <div class="container from">
         <form action="FarmerHistory.do" method="post" name="historyForm" >
            ...
            <br/>
            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-6 " style="padding-right:0px;"><button id="button" style="border-color:#BDD102 ;background-color:#BDD102; color:black; font-weight:bold;"  onclick="javascript:history()" class="btn btn-primary" ><%=session.getValue("summary.getHistory") %></button></div>
            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-6 " style="padding-left:0px;"><button   id="download-btn"  style="border-color:#3C4DA0;background-color:#3C4DA0; " class="btn btn-primary"><%=session.getValue("summary.PDF") %></button></div>
         </form>
      </div>
      <%
...
//                                myEarn1=myEarn1/100;
                        ...
                        <td class="clspad0" width="15%">
                           <h4  style="color:#000080;text-align:center;"><b><%=fhb.getCrdate() %></b></h4>
                        </td>
                        <td class="clspad0">
                           <h4  style="color:#000080;text-align:center;"><b><%=(String)hs.getAttribute("name")%></b></h4>
                        </td>
                        <!--  <td class="clspad0">
                           <h4  style="color:#000080"><b><%=fhb.getFarmerid()%></b></h4></td>--> 
                        <td>
                           <h4  style="color:#000080;text-align:center;"><b><%=fhb.getLotnumber()  %></b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080;text-align:center;"><b><%=fhb.getQuantity() %></b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080;text-align:center;"><b><%=fhb.getQuantitybidfor()%></b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080;text-align:center;"><b><%=fhb.getAverageprice()%></b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080;text-align:center;"><b><%=fprice1%></b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080;text-align:center;"><b>500</b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080;text-align:center;"><b><%=MUCharge1 %></b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080;text-align:center;"><b>100</b></h4>
                        </td>
                        <td>
                           <h4  style="color:#000080;text-align:center;"><b>100</b></h4>
                        </td>
