                    ...
                    <table class="table sum1table last">
                        ...
                        <tbody>
                            <tr class="gradeX">
                                <td></td>
                                <td class="clspad0">
                                    <h4 style="color:#000080"><b><%=lotnumber %></b></h4>
                                </td>
                                <td>
                                    <h4 style="color:#000080"><b><%=lotsize%></b></h4>
                                </td>
                                <td>
                                    <h4 style="color:#000080"><b><%=quantitysold %></b></h4>
                                </td>
                                <td>
                                    <h4 style="color:#000080"><b><%= aprice%></b></h4>
                                </td>
                                <td>
                                    <h4 style="color:#000080"><b>--</b></h4>
                                </td>
                                <td>
                                    <h4 style="color:#000080"><b>--</b></h4>
                                </td>
                                ...
                                <td width="25%">
                                    <h4 style="color:#000080"><b><%=status%></h4>
                                </td>
                                <td></td>
                            </tr>
                        </tbody>
