   ...
   <body class="" >
      <div class="logo_relative">
         <div class="hidden-xs logo ">
            <img src="images/trad_logo.png" class="img-responsive">
         </div>
         <div class="container-fluid headertop">
            <div class="">
               ...
               <div class="col-lg-1 col-sm-2 col-md-2 col-xs-2 power">
                  <a class="pull-right" href="FLogout.do">
               ...
               <table class="table sum1table last">
                  ...
                  <tbody>
                     <tr class="gradeX">
                        ...
                        <td class="clspad0">
                           <h4 style="color:#000080; font-weight:bold;">
                              <%=lotnumber %>
                           </h4>
                        </td>
                        <td>
                        ...
                        <td>
                           <h4  style="color:#000080; font-weight:bold;">500
                           </h4>
                        </td>
                        <td style=" width:20px;">
                           <h4  style="color:#000080; font-weight:bold;">
                        ...
                        <td>
                           <h4  style="color:#000080; font-weight:bold;">100
                           </h4>
                        </td>
                        <td>
                           <h4  style="color:#000080; font-weight:bold;">100
