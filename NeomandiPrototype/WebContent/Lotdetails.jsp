				...
				<div class="lottable">
					...
					<table class="table ltable">
						...
						<tbody>
							...
							<tr class="gradeX">
								<td></td>
								<td><button type="button" class="btn popup" data-toggle="modal" data-target="#myModal1" style="color:#000080; border-radius:9px; border: 1px solid #808080;"> <%=lotnumber %></button></td>
								<td>
									<h4  style="color:#000080"><%=product%></h4>
								</td>
								<td>
									<h4  style="color:#000080"><%=rs1.getString("produce")%></h4>
								</td>
								<td>
									<h4  style="color:#000080"><%=grade%></h4>
								</td>
								<td>
									<h4  style="color:#000080"><%=quantity %></h4>
								</td>
								<td></td>
							</tr>
							<%
