	...
	<table border="1">
		...
		%>
		 ...
		 <tr>
			 ...
			 <td></td>
			 <td><form action="FarmerTradeSummary.jsp">
			 <input  id="accept" type="submit" value="Accept " onclick="setDisable()" ></td>
			 <td><input  id="reject" type="submit" value="Reject"></form></td>
			 <td>
