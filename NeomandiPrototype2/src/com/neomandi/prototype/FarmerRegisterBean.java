...
public class FarmerRegisterBean {
	...
	public int getFarmerMobile() {
		return farmerMobile;
	}
	public void setFarmerMobile(int farmerMobile) {
	...
	public String toString() {
		return "FarmerRegisterBean [farmerName=" + farmerName + ", farmerMobile=" + farmerMobile + ", farmerAadharnum="
				...
				+ ", farmerPass=" + farmerPass + ", farmerPhoto=" + farmerPhoto + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
		...
		result = prime * result + farmerMobile;
		result = prime * result + ((farmerName == null) ? 0 : farmerName.hashCode());
		result = prime * result + ((farmerPass == null) ? 0 : farmerPass.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (farmerName == null) {
			...
			return false;
		if (farmerPass == null) {
			if (other.farmerPass != null)
				return false;
		} else if (!farmerPass.equals(other.farmerPass))
			return false;
		if (farmerPhoto == null) {
	...
	public FarmerRegisterBean(String farmerName, int farmerMobile, long farmerAadharnum, String farmerEmail,
			String farmerState, String farmerDistrict, String farmerTaluk, String farmerHobli, String farmerVillage,
			String farmerBankName, long farmerAccountNum, String farmerBranch, String farmerIfscCode, String farmerPass,
			String farmerPhoto) {
		super();
		this.farmerName = farmerName;
		this.farmerMobile = farmerMobile;
